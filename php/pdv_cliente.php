...
$body	=	'onLoad="document.form1.q.focus()"';
	...
	if ( $_POST['pesquisar'] && $_POST['q'] )
	{
		...
		if ( $result = mysql_query( "Select clientes.id, clientes.nome From clientes Where clientes.nome Like '%$q%' AND clientes.`status` = 'A'" ) )
		{
...
';
	...
	elseif ( $_POST['codp'] )
	{
		$_SESSION['id_cliente']	=	$_POST['codp'];
	...
	$tpl->assign( 'conteudo', 'pdv_cliente.html' );
