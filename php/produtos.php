<?php	session_start();
	...
	// Lista fornecedores ////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////////////
	if ( $result = mysql_query( "Select produtos.id, produtos.codigo, produtos.descricao, produtos.estoque From produtos Order By produtos.descricao Asc" ) )
	{
		for ( $i = 0; $i < mysql_num_rows( $result ); $i++ )
		{
			...
			$estoque	=	mysql_result( $result, $i, 'estoque' );
        ...
        <td align="right" class="lista_linhas"><a href="produtos_editar.php?id_produto=' . $id_produto . '" class="lista_link">' . $estoque . '</a></td>
        </tr>
';
		}
	...
	$tpl->assign( 'conteudo', 'produtos.html' );
